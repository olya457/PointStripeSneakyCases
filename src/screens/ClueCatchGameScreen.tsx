...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#0f1e5a' },
  topBar: { paddingTop: 58, paddingHorizontal: 18, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  scoreLabel: { color: 'rgba(238,242,255,0.6)', fontSize: 12, letterSpacing: 2, marginBottom: 4 },
  scoreValue: { color: '#ffc21c', fontSize: 24, fontWeight: '900' },
  centerInfo: { alignItems: 'center', marginTop: 2 },
  roundText: { color: '#eef2ff', fontSize: 12, letterSpacing: 2, fontWeight: '800', marginBottom: 4 },
  timeText: { color: '#ffc21c', fontSize: 24, fontWeight: '900' },
  topRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  hearts: { color: '#fff', fontSize: 18 },
  pause: { width: 36, height: 36, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.15)', alignItems: 'center', justifyContent: 'center' },
  pauseText: { color: '#f1f4ff', fontWeight: '900' },
  token: { position: 'absolute' },
  tokenButton: { alignItems: 'center', justifyContent: 'center' },
  overlay: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(8,11,28,0.46)', alignItems: 'center', justifyContent: 'center', padding: 22 },
  modal: { width: '100%', borderRadius: 28, backgroundColor: '#203273', padding: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  modalTitle: { color: '#f1f4ff', fontSize: 30, fontWeight: '900', textAlign: 'center', marginBottom: 16 },
  modalText: { color: 'rgba(231,237,255,0.76)', fontSize: 16, lineHeight: 30, textAlign: 'center', marginBottom: 20 },
  resultStats: { flexDirection: 'row', gap: 10, marginBottom: 20 },
  resultStat: { flex: 1, borderRadius: 16, paddingVertical: 14, backgroundColor: 'rgba(255,255,255,0.06)', alignItems: 'center' },
  resultStatValue: { color: '#ffc21c', fontSize: 22, fontWeight: '900', marginBottom: 4 },
  resultStatLabel: { color: 'rgba(231,237,255,0.68)', fontSize: 11, letterSpacing: 1.5, fontWeight: '800' },
  ...
  quitButtonText: { color: '#ff9d90', fontSize: 18, fontWeight: '800' },
});
