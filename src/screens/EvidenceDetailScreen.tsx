...
const styles = StyleSheet.create({container:{flex:1,backgroundColor:'#101f61',paddingHorizontal:22},back:{alignSelf:'flex-start',backgroundColor:'#243b8e',paddingHorizontal:14,paddingVertical:10,borderRadius:18,marginBottom:14},backText:{color:'#eef2ff',fontWeight:'700'},headerRow:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:12},eyebrow:{color:'#ffc21c',fontSize:12,letterSpacing:4,fontWeight:'800',marginBottom:8},title:{color:'#f3f6ff',fontSize:26,fontWeight:'900'},reset:{width:68,height:38,borderRadius:18,borderWidth:1,borderColor:'rgba(255,255,255,0.18)',alignItems:'center',justifyContent:'center'},resetText:{color:'#eef2ff',fontWeight:'700'},progressBar:{height:8,borderRadius:999,backgroundColor:'rgba(255,255,255,0.14)',overflow:'hidden',marginBottom:8},progressFill:{height:'100%',backgroundColor:'#ffc21c'},progressText:{color:'#ffc21c',alignSelf:'flex-end',marginBottom:14,fontWeight:'800'},introBox:{backgroundColor:'#203273',borderRadius:18,padding:16,marginBottom:18},introText:{color:'#e8eeff',fontSize:15,lineHeight:28},section:{color:'rgba(222,230,255,0.58)',fontSize:12,letterSpacing:3,fontWeight:'800',marginBottom:12},unsortedWrap:{borderRadius:20,borderWidth:1,borderStyle:'dashed',borderColor:'rgba(255,255,255,0.16)',padding:12,marginBottom:16},clue:{flexDirection:'row',alignItems:'center',borderWidth:1,borderColor:'rgba(255,194,28,0.42)',borderRadius:14,paddingHorizontal:12,paddingVertical:12,marginBottom:10},clueSelected:{backgroundColor:'rgba(255,194,28,0.12)'},redDot:{width:10,height:10,borderRadius:5,backgroundColor:'#ff5335',marginRight:10},clueText:{color:'#f0f4ff',fontSize:16},emptyText:{color:'rgba(229,236,255,0.62)',fontSize:15,lineHeight:24},bucket:{backgroundColor:'#203273',borderRadius:18,padding:16,marginBottom:14,borderWidth:1,borderColor:'rgba(255,255,255,0.08)'},bucketActive:{borderColor:'#ffc21c'},bucketTitle:{color:'#eef2ff',fontSize:18,fontWeight:'900',marginBottom:10},bucketSub:{color:'rgba(231,237,255,0.42)',fontSize:14,fontWeight:'500'},bucketClue:{paddingVertical:2},bucketItem:{color:'#dff7ea',fontSize:16,lineHeight:28,marginBottom:4},bucketPlaceholder:{color:'rgba(230,236,255,0.46)'},checkButton:{height:58,borderRadius:18,backgroundColor:'#ffc21c',alignItems:'center',justifyContent:'center',marginTop:4},checkButtonDisabled:{backgroundColor:'#2b3d7a'},checkButtonText:{color:'#1e2338',fontSize:18,fontWeight:'800'},result:{borderRadius:22,padding:18,marginTop:14,borderWidth:1},resultGood:{backgroundColor:'#183e63',borderColor:'rgba(57,208,123,0.35)'},resultBad:{backgroundColor:'#34284e',borderColor:'rgba(255,83,53,0.35)'},resultTitle:{fontSize:20,fontWeight:'900',marginBottom:10},resultTitleGood:{color:'#39d07b'},resultTitleBad:{color:'#ff9d90'},resultBody:{color:'#eef2ff',fontSize:16,lineHeight:28},retryButton:{marginTop:16,height:50,borderRadius:16,borderWidth:1,borderColor:'rgba(255,255,255,0.18)',alignItems:'center',justifyContent:'center',backgroundColor:'rgba(255,255,255,0.04)'},retryButtonText:{color:'#eef2ff',fontSize:16,fontWeight:'800'}});
