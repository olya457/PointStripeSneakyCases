...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#101f61', paddingHorizontal: 22 },
  header: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  avatar: { width: 76, height: 76, marginRight: 14 },
  name: { color: '#f2f5ff', fontSize: 22, fontWeight: '900', marginBottom: 6 },
  rank: { color: '#ffc21c', letterSpacing: 3, fontSize: 12 },
  progressCard: { backgroundColor: '#203273', borderRadius: 22, padding: 16, marginBottom: 16 },
  progressHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
  progressLabel: { color: '#eef2ff', fontWeight: '700' },
  progressBar: { height: 10, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.14)', overflow: 'hidden', marginBottom: 10 },
  progressFill: { height: '100%', backgroundColor: '#ffc21c' },
  progressNote: { color: 'rgba(231,237,255,0.52)', fontSize: 13 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 18 },
  statCard: { width: '48.5%', borderRadius: 20, padding: 16, borderWidth: 1 },
  gold: { backgroundColor: '#203273', borderColor: 'rgba(255,194,28,0.26)' },
  green: { backgroundColor: '#173f64', borderColor: 'rgba(57,208,123,0.26)' },
  pink: { backgroundColor: '#34284e', borderColor: 'rgba(255,83,53,0.26)' },
  blue: { backgroundColor: '#203273', borderColor: 'rgba(98,168,255,0.26)' },
  goldNumber: { color: '#ffc21c', fontSize: 24, fontWeight: '900', marginBottom: 6 },
  greenNumber: { color: '#39d07b', fontSize: 24, fontWeight: '900', marginBottom: 6 },
  pinkNumber: { color: '#ff9d90', fontSize: 24, fontWeight: '900', marginBottom: 6 },
  blueNumber: { color: '#74baff', fontSize: 24, fontWeight: '900', marginBottom: 6 },
  statText: { color: 'rgba(231,237,255,0.7)' },
  section: { color: '#ffc21c', fontSize: 12, letterSpacing: 4, fontWeight: '800', marginBottom: 12 },
  activityCard: { backgroundColor: '#203273', borderRadius: 18, padding: 16, marginBottom: 12 },
  activityTitle: { color: '#eef2ff', fontSize: 16, fontWeight: '700', marginBottom: 6 },
  activityMeta: { color: 'rgba(231,237,255,0.56)' },
});
